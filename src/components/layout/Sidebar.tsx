...
const Icon = ({ name, size = 14, color = 'currentColor' }: { name: string; size?: number; color?: string }) => {
  ...
  const icons: Record<string, React.ReactNode> = {
    ...
    stakeholders: <svg style={s} viewBox="0 0 14 14" fill="none"><circle cx="5" cy="4.5" r="2" stroke={color} strokeWidth="1.1"/><circle cx="10" cy="4" r="1.5" stroke={color} strokeWidth="1.1"/><path d="M1 11.5C1 9.57 2.79 8 5 8C7.21 8 9 9.57 9 11.5" stroke={color} strokeWidth="1.1" strokeLinecap="round"/><path d="M10 7.5C11.5 7.5 13 8.7 13 10.5" stroke={color} strokeWidth="1.1" strokeLinecap="round"/></svg>,
    writer:     <svg style={s} viewBox="0 0 14 14" fill="none"><path d="M9 2L12 5L5 12H2V9L9 2Z" stroke={color} strokeWidth="1.1" strokeLinejoin="round"/><line x1="7" y1="4" x2="10" y2="7" stroke={color} strokeWidth="1"/></svg>,
    ...
    boardpack:  <svg style={s} viewBox="0 0 14 14" fill="none"><rect x="1.5" y="1.5" width="11" height="11" rx="1.5" stroke={color} strokeWidth="1.1"/><line x1="3.5" y1="4.5" x2="10.5" y2="4.5" stroke={color} strokeWidth="1"/><line x1="3.5" y1="7" x2="10.5" y2="7" stroke={color} strokeWidth="1"/><line x1="3.5" y1="9.5" x2="7" y2="9.5" stroke={color} strokeWidth="1"/><circle cx="10" cy="9.5" r="1.5" stroke={color} strokeWidth="1"/><line x1="9" y1="9.5" x2="8" y2="9.5" stroke={color} strokeWidth="0.8"/></svg>,
...
const NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/platform/board-pack',        icon: 'boardpack',    label: 'Board Pack',        badge: 'NEW',   accent: C.violet },
      ...
      { href: '/platform/deadline-tracker', icon: 'knowledge', label: 'Deadlines',       badge:'🔴', accent: C.pro },
      { href: '/platform/daily-brief',     icon: 'knowledge', label: 'Morning Brief',    accent: C.pro },
      { href: '/platform/onboarding',      icon: 'knowledge', label: 'Platform Readiness', badge:'NEW', accent: C.pro },
      { href: '/platform/agents',           icon: 'knowledge', label: 'Background Agents', badge:'NEW', accent: C.pro },
      { href: '/platform/knowledge-graph', icon: 'knowledge', label: 'Knowledge Graph', badge:'NEW', accent: C.pro },
      { href: '/platform/intelligence',     icon: 'intelligence', label: 'Intelligence',                      accent: C.pro },
      { href: '/platform/stakeholders',      icon: 'stakeholders', label: 'Stakeholders',   badge:'NEW',   accent: C.academic },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/platform/meetings-live', icon: 'meetings', label: 'Agentic Meetings', badge: 'NEW', accent: C.pro },
