        ...
        if (urgentTasks.length > 0 && overdue.length > 0) {
          ...
          await sendEmail({
            ...
            html: `<div style="font-family:sans-serif;max-width:600px;margin:0 auto;padding:24px">
              ...
              <p style="color:#6b7280;font-size:12px;margin-top:16px">Sent by PIOS · <a href="${process.env.NEXT_PUBLIC_APP_URL ?? 'https://pios.veritasiq.tech'}/platform/tasks">View all tasks →</a></p>
            </div>`,
