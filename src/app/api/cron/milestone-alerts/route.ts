    ...
    const bodyHtml = `
      <div style="font-family:system-ui,sans-serif;max-width:480px;margin:0 auto">
        ...
        <div style="background:#fff;padding:24px;border:1px solid #e5e7eb;border-radius:0 0 8px 8px">
          ...
          <a href="${process.env.NEXT_PUBLIC_APP_URL ?? 'https://pios.sustain-intl.com'}/platform/learning" style="display:inline-block;background:#8B5CF6;color:#fff;padding:10px 20px;border-radius:6px;text-decoration:none;font-size:13px;font-weight:600;margin-top:8px">View in PIOS →</a>
        </div>
      </div>
    `
