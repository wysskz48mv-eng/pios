  ...
  try {
    ...
    const { error: calErr } = await adminSb
      ...
      .upsert({
        ...
        qualifications:          ['DBA candidate (University of Portsmouth)', 'Chartered FM Professional', 'Facilities Management professional'],
        employers:               ['VeritasIQ Technologies Ltd', 'GCC FM Consultancy'],
