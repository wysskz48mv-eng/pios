...
export async function POST() {
  try {
    ...
    const system = `You are an FM industry intelligence analyst. Generate a daily FM market intelligence digest for Douglas Masuku, CEO of Sustain International FZE Ltd, an FM consulting and SaaS company operating in the GCC (Saudi Arabia, UAE, Qatar). Douglas is also a DBA researcher studying AI adoption in GCC FM.
