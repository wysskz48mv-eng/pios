...
export default function AdminPage() {
  ...
  const appliedCount = Object.values(status).filter((s: any) => s.applied).length
      ...
      <div className="pios-card" style={{ marginTop:16 }}>
        ...
        <div style={{ display:'flex', flexDirection:'column', gap:6 }}>
          {[
            ...
            { key:'NEXT_PUBLIC_APP_URL',           value:'https://pios-wysskz48mv-engs-projects.vercel.app', required:true },
